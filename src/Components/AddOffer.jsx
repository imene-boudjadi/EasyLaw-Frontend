...
export default function AddOffer({ onClose, tarification, updateTarification }) {
  ...
  const handleUpdate = () => {
    fetch(`http://localhost:8000/tarification/${tarification.id}`, {
      ...
      .then(data => {
        ...
        updateTarification({ ...tarification, tarif: updatedTarif, description: updatedDescription, duree:updatedDuree });
      ...
      <div className='flex flex-col'>
        <div className='flex flex-row mb-3'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <select className='inputStyle w-full px-5 py-1' value={updatedDuree} onChange={e => setUpdatedDuree(e.target.value)}>
              <option value='Annuelle'>سنوي</option>
